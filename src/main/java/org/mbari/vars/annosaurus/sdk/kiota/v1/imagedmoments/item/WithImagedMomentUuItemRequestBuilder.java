package org.mbari.vars.annosaurus.sdk.kiota.v1.imagedmoments.item;
...
public class WithImagedMomentUuItemRequestBuilder extends BaseRequestBuilder {
    ...
    public WithImagedMomentUuItemRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/v1/imagedmoments/{imagedMomentUuid}", pathParameters);
    }
    /**
     * Instantiates a new {@link WithImagedMomentUuItemRequestBuilder} and sets the default values.
    ...
    public WithImagedMomentUuItemRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/v1/imagedmoments/{imagedMomentUuid}", rawUrl);
    }
    /**
     * Delete an imaged moment
     ...
     */
    @jakarta.annotation.Nullable
    public ImagedMomentSC get(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = toGetRequestInformation(requestConfiguration);
        final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>();
        errorMapping.put("400", BadRequest::createFromDiscriminatorValue);
        errorMapping.put("404", NotFound::createFromDiscriminatorValue);
        errorMapping.put("500", ServerError::createFromDiscriminatorValue);
        return this.requestAdapter.send(requestInfo, errorMapping, ImagedMomentSC::createFromDiscriminatorValue);
    }
    /**
     * Update an imaged moment
     ...
     */
    @jakarta.annotation.Nullable
    public ImagedMomentSC put(@jakarta.annotation.Nonnull final VideoTimestampSC body) {
     ...
     */
    @jakarta.annotation.Nullable
    public ImagedMomentSC put(@jakarta.annotation.Nonnull final VideoTimestampSC body, @jakarta.annotation.Nullable final java.util.function.Consumer<PutRequestConfiguration> requestConfiguration) {
     ...
     */
    @jakarta.annotation.Nonnull
    public RequestInformation toPutRequestInformation(@jakarta.annotation.Nonnull final VideoTimestampSC body) {
     ...
     */
    @jakarta.annotation.Nonnull
    public RequestInformation toPutRequestInformation(@jakarta.annotation.Nonnull final VideoTimestampSC body, @jakarta.annotation.Nullable final java.util.function.Consumer<PutRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
