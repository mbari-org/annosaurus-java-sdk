...
public class QueryConstraintsResponseSCDepthHistogramSC implements AdditionalDataHolder, Parsable {
    /**
     ...
     */
    private DepthHistogramSC content;
    /**
     * The query_constraints property
     */
    private QueryConstraintsSC queryConstraints;
    /**
     * Instantiates a new {@link QueryConstraintsResponseSCDepthHistogramSC} and sets the default values.
     */
    public QueryConstraintsResponseSCDepthHistogramSC() {
    ...
    public static QueryConstraintsResponseSCDepthHistogramSC createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new QueryConstraintsResponseSCDepthHistogramSC();
    }
    /**
    ...
    public DepthHistogramSC getContent() {
        return this.content;
    }
    /**
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("content", (n) -> { this.setContent(n.getObjectValue(DepthHistogramSC::createFromDiscriminatorValue)); });
     ...
     */
    public void setContent(@jakarta.annotation.Nullable final DepthHistogramSC value) {
        this.content = value;
    }
    /**
