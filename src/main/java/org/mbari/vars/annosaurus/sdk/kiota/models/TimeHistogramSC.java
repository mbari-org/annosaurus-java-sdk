...
public class TimeHistogramSC implements AdditionalDataHolder, Parsable {
    /**
     ...
     */
    private java.util.List<String> binsMax;
    /**
     * The bins_min property
     */
    private java.util.List<String> binsMin;
    /**
     * The values property
     */
    private java.util.List<Integer> values;
    /**
     * Instantiates a new {@link TimeHistogramSC} and sets the default values.
     */
    public TimeHistogramSC() {
        this.setAdditionalData(new HashMap<>());
    }
    /**
     * Creates a new instance of the appropriate class based on discriminator value
     * @param parseNode The parse node to use to read the discriminator value and create the object
     * @return a {@link TimeHistogramSC}
     */
    @jakarta.annotation.Nonnull
    public static TimeHistogramSC createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new TimeHistogramSC();
    }
    /**
    ...
    public java.util.List<String> getBinsMax() {
        return this.binsMax;
    }
    /**
     ...
     */
    @jakarta.annotation.Nullable
    public java.util.List<String> getBinsMin() {
        return this.binsMin;
    }
    /**
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("bins_max", (n) -> { this.setBinsMax(n.getCollectionOfPrimitiveValues(String.class)); });
        deserializerMap.put("bins_min", (n) -> { this.setBinsMin(n.getCollectionOfPrimitiveValues(String.class)); });
     ...
     */
    public void setBinsMax(@jakarta.annotation.Nullable final java.util.List<String> value) {
        this.binsMax = value;
    }
    /**
     ...
     */
    public void setBinsMin(@jakarta.annotation.Nullable final java.util.List<String> value) {
        this.binsMin = value;
    }
    /**
