...
public class Count implements AdditionalDataHolder, Parsable {
    /**
    ...
    private Long count;
    /**
     * Instantiates a new {@link Count} and sets the default values.
     */
    public Count() {
    ...
    public static Count createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
