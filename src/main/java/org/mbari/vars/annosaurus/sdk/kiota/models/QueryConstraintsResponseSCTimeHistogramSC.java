...
public class QueryConstraintsResponseSCTimeHistogramSC implements AdditionalDataHolder, Parsable {
    /**
     ...
     */
    private TimeHistogramSC content;
    /**
     * The query_constraints property
     */
    private QueryConstraintsSC queryConstraints;
    /**
     * Instantiates a new {@link QueryConstraintsResponseSCTimeHistogramSC} and sets the default values.
     */
    public QueryConstraintsResponseSCTimeHistogramSC() {
    ...
    public static QueryConstraintsResponseSCTimeHistogramSC createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new QueryConstraintsResponseSCTimeHistogramSC();
    }
    /**
    ...
    public TimeHistogramSC getContent() {
        return this.content;
    }
    /**
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("content", (n) -> { this.setContent(n.getObjectValue(TimeHistogramSC::createFromDiscriminatorValue)); });
     ...
     */
    public void setContent(@jakarta.annotation.Nullable final TimeHistogramSC value) {
        this.content = value;
    }
    /**
