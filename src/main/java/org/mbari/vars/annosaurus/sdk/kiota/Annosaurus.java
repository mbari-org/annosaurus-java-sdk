package org.mbari.vars.annosaurus.sdk.kiota;
...
import org.mbari.vars.annosaurus.sdk.kiota.v1.V1RequestBuilder;
/**
 * The main entry point of the SDK, exposes the configuration and the fluent API.
 */
@jakarta.annotation.Generated("com.microsoft.kiota")
public class Annosaurus extends BaseRequestBuilder {
    /**
     * The v1 property
    ...
    /**
     * Instantiates a new {@link Annosaurus} and sets the default values.
     * @param requestAdapter The request adapter to use to execute the requests.
     */
    public Annosaurus(@jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
