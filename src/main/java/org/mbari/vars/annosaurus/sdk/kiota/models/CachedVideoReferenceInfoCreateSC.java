...
public class CachedVideoReferenceInfoCreateSC implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link CachedVideoReferenceInfoCreateSC} and sets the default values.
     */
    public CachedVideoReferenceInfoCreateSC() {
        this.setAdditionalData(new HashMap<>());
    }
    /**
     * Creates a new instance of the appropriate class based on discriminator value
     * @param parseNode The parse node to use to read the discriminator value and create the object
     * @return a {@link CachedVideoReferenceInfoCreateSC}
     */
    @jakarta.annotation.Nonnull
    public static CachedVideoReferenceInfoCreateSC createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new CachedVideoReferenceInfoCreateSC();
    }
    /**
