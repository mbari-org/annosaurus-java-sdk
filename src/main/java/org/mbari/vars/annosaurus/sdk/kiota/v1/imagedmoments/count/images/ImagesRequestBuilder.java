package org.mbari.vars.annosaurus.sdk.kiota.v1.imagedmoments.count.images;
...
import org.mbari.vars.annosaurus.sdk.kiota.v1.imagedmoments.count.images.item.WithVideoReferenceUuItemRequestBuilder;
/**
...
public class ImagesRequestBuilder extends BaseRequestBuilder {
    /**
     * Gets an item from the org.mbari.vars.annosaurus.sdk.kiota.v1.imagedmoments.count.images.item collection
    ...
    public ImagesRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/v1/imagedmoments/count/images", pathParameters);
    }
    /**
     * Instantiates a new {@link ImagesRequestBuilder} and sets the default values.
    ...
    public ImagesRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/v1/imagedmoments/count/images", rawUrl);
    }
    /**
     * Count all imaged moments with images
     * @return a {@link Count}
