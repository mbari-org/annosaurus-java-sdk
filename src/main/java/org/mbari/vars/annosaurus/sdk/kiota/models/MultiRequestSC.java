...
public class MultiRequestSC implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link MultiRequestSC} and sets the default values.
     */
    public MultiRequestSC() {
    ...
    public static MultiRequestSC createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new MultiRequestSC();
    }
    /**
