package org.mbari.vars.annosaurus.sdk.kiota.v1.observations.concept.rename;
...
import org.mbari.vars.annosaurus.sdk.kiota.models.RenameCountSC;
...
public class RenameRequestBuilder extends BaseRequestBuilder {
    ...
    public RenameRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/v1/observations/concept/rename", pathParameters);
    }
    /**
     * Instantiates a new {@link RenameRequestBuilder} and sets the default values.
    ...
    public RenameRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/v1/observations/concept/rename", rawUrl);
    }
    /**
     * Rename a concept in all observations
    ...
    public RenameCountSC put(@jakarta.annotation.Nonnull final RenameConcept body) {
     ...
     */
    @jakarta.annotation.Nullable
    public RenameCountSC put(@jakarta.annotation.Nonnull final RenameConcept body, @jakarta.annotation.Nullable final java.util.function.Consumer<PutRequestConfiguration> requestConfiguration) {
        ...
        return this.requestAdapter.send(requestInfo, errorMapping, RenameCountSC::createFromDiscriminatorValue);
    }
    /**
     * Rename a concept in all observations
     * @param body The request body
    ...
    public RequestInformation toPutRequestInformation(@jakarta.annotation.Nonnull final RenameConcept body) {
     ...
     */
    @jakarta.annotation.Nonnull
    public RequestInformation toPutRequestInformation(@jakarta.annotation.Nonnull final RenameConcept body, @jakarta.annotation.Nullable final java.util.function.Consumer<PutRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
