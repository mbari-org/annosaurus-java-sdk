...
public class AnnotationCreateSC implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link AnnotationCreateSC} and sets the default values.
     */
    public AnnotationCreateSC() {
        this.setAdditionalData(new HashMap<>());
    }
    /**
     * Creates a new instance of the appropriate class based on discriminator value
     * @param parseNode The parse node to use to read the discriminator value and create the object
     * @return a {@link AnnotationCreateSC}
     */
    @jakarta.annotation.Nonnull
    public static AnnotationCreateSC createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new AnnotationCreateSC();
    }
    /**
