package org.mbari.vars.annosaurus.sdk.kiota.v1.imagereferences.item;
...
public class WithImageReferenceUuItemRequestBuilder extends BaseRequestBuilder {
    ...
    public WithImageReferenceUuItemRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/v1/imagereferences/{imageReferenceUuid}", pathParameters);
    }
    /**
     * Instantiates a new {@link WithImageReferenceUuItemRequestBuilder} and sets the default values.
    ...
    public WithImageReferenceUuItemRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/v1/imagereferences/{imageReferenceUuid}", rawUrl);
    }
    /**
     * Delete an image reference by its UUID
     ...
     */
    @jakarta.annotation.Nullable
    public ImageReferenceSC get(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        final RequestInformation requestInfo = toGetRequestInformation(requestConfiguration);
        final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>();
        errorMapping.put("400", BadRequest::createFromDiscriminatorValue);
        errorMapping.put("404", NotFound::createFromDiscriminatorValue);
        errorMapping.put("500", ServerError::createFromDiscriminatorValue);
        return this.requestAdapter.send(requestInfo, errorMapping, ImageReferenceSC::createFromDiscriminatorValue);
    }
    /**
     * Update an image reference by its UUID and a json or form body
     ...
     */
    @jakarta.annotation.Nullable
    public ImageReferenceSC put(@jakarta.annotation.Nonnull final ImageReferenceSC body) {
     ...
     */
    @jakarta.annotation.Nullable
    public ImageReferenceSC put(@jakarta.annotation.Nonnull final ImageReferenceSC body, @jakarta.annotation.Nullable final java.util.function.Consumer<PutRequestConfiguration> requestConfiguration) {
     ...
     */
    @jakarta.annotation.Nonnull
    public RequestInformation toPutRequestInformation(@jakarta.annotation.Nonnull final ImageReferenceSC body) {
     ...
     */
    @jakarta.annotation.Nonnull
    public RequestInformation toPutRequestInformation(@jakarta.annotation.Nonnull final ImageReferenceSC body, @jakarta.annotation.Nullable final java.util.function.Consumer<PutRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
