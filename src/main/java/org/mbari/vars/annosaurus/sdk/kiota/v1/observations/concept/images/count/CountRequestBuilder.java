package org.mbari.vars.annosaurus.sdk.kiota.v1.observations.concept.images.count;
...
import org.mbari.vars.annosaurus.sdk.kiota.v1.observations.concept.images.count.item.WithConceptItemRequestBuilder;
/**
...
public class CountRequestBuilder extends BaseRequestBuilder {
    /**
     * Gets an item from the org.mbari.vars.annosaurus.sdk.kiota.v1.observations.concept.images.count.item collection
    ...
    public CountRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/v1/observations/concept/images/count", pathParameters);
    }
    /**
     * Instantiates a new {@link CountRequestBuilder} and sets the default values.
    ...
    public CountRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/v1/observations/concept/images/count", rawUrl);
    }
}
