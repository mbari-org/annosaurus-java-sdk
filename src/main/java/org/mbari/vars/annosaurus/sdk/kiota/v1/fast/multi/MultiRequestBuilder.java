package org.mbari.vars.annosaurus.sdk.kiota.v1.fast.multi;
...
public class MultiRequestBuilder extends BaseRequestBuilder {
    ...
    public MultiRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/v1/fast/multi{?data*,limit*,offset*}", pathParameters);
    }
    /**
     * Instantiates a new {@link MultiRequestBuilder} and sets the default values.
    ...
    public MultiRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/v1/fast/multi{?data*,limit*,offset*}", rawUrl);
    }
    /**
    ...
    public java.util.List<AnnotationSC> post(@jakarta.annotation.Nonnull final MultiRequestSC body) {
     ...
     */
    @jakarta.annotation.Nullable
    public java.util.List<AnnotationSC> post(@jakarta.annotation.Nonnull final MultiRequestSC body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
    ...
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final MultiRequestSC body) {
     ...
     */
    @jakarta.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final MultiRequestSC body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        Objects.requireNonNull(body);
     ...
     */
    @jakarta.annotation.Nonnull
    public MultiRequestBuilder withUrl(@jakarta.annotation.Nonnull final String rawUrl) {
