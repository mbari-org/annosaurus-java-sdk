...
public class ImageCreateSC implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link ImageCreateSC} and sets the default values.
     */
     ...
     * @return a {@link ImageCreateSC}
     */
    @jakarta.annotation.Nonnull
    public static ImageCreateSC createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ImageCreateSC();
    }
    /**
