package org.mbari.vars.annosaurus.sdk.kiota.v1.imagedmoments.videoreference.modified.item.item;
...
public class WithDateItemRequestBuilder extends BaseRequestBuilder {
    /**
     * Instantiates a new {@link WithDateItemRequestBuilder} and sets the default values.
     * @param pathParameters Path parameters for the request
     * @param requestAdapter The request adapter to use to execute the requests.
     */
    public WithDateItemRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/v1/imagedmoments/videoreference/modified/{uuid}/{date}", pathParameters);
    }
    /**
     * Instantiates a new {@link WithDateItemRequestBuilder} and sets the default values.
     ...
     * @param requestAdapter The request adapter to use to execute the requests.
     */
    public WithDateItemRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/v1/imagedmoments/videoreference/modified/{uuid}/{date}", rawUrl);
    }
    /**
     ...
     */
    @jakarta.annotation.Nonnull
    public WithDateItemRequestBuilder withUrl(@jakarta.annotation.Nonnull final String rawUrl) {
