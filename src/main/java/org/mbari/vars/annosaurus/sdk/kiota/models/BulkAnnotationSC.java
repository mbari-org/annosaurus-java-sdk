...
public class BulkAnnotationSC implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link BulkAnnotationSC} and sets the default values.
     */
    public BulkAnnotationSC() {
        this.setAdditionalData(new HashMap<>());
    }
    /**
     * Creates a new instance of the appropriate class based on discriminator value
     * @param parseNode The parse node to use to read the discriminator value and create the object
     * @return a {@link BulkAnnotationSC}
     */
    @jakarta.annotation.Nonnull
    public static BulkAnnotationSC createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new BulkAnnotationSC();
    }
    /**
