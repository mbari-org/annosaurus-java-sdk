 ...
 */
package org.mbari.vars.annosaurus.sdk.kiota.v1.query.download;
...
/**
 * Builds and executes requests for operations under /v1/query/download
 */
...
public class DownloadRequestBuilder extends BaseRequestBuilder {
    ...
    public DownloadRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/v1/query/download", pathParameters);
    }
    /**
     * Instantiates a new {@link DownloadRequestBuilder} and sets the default values.
    ...
    public DownloadRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/v1/query/download", rawUrl);
    }
    /**
     * Run a query and download the results as a tab-separate value file
    ...
    public InputStream post(@jakarta.annotation.Nonnull final QueryRequest body) {
     ...
     */
    @jakarta.annotation.Nullable
    public InputStream post(@jakarta.annotation.Nonnull final QueryRequest body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
    ...
    public RequestInformation toPostRequestInformation(@jakarta.annotation.Nonnull final QueryRequest body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
        ...
        requestInfo.headers.tryAdd("Accept", "text/tab-separated-values, application/json");
