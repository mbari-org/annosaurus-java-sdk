 ...
 */
package org.mbari.vars.annosaurus.sdk.kiota.v1.annotations.association;
...
import org.mbari.vars.annosaurus.sdk.kiota.v1.annotations.association.item.WithAssociationUuItemRequestBuilder;
/**
 * Builds and executes requests for operations under /v1/annotations/association
 */
@jakarta.annotation.Generated("com.microsoft.kiota")
public class AssociationRequestBuilder extends BaseRequestBuilder {
    /**
     * Gets an item from the org.mbari.vars.annosaurus.sdk.kiota.v1.annotations.association.item collection
    ...
    public AssociationRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/v1/annotations/association", pathParameters);
    }
    /**
     * Instantiates a new {@link AssociationRequestBuilder} and sets the default values.
    ...
    public AssociationRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/v1/annotations/association", rawUrl);
    }
}
