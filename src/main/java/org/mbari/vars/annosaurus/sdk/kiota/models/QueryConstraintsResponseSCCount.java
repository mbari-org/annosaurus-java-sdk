...
public class QueryConstraintsResponseSCCount implements AdditionalDataHolder, Parsable {
    /**
     ...
     */
    private Count content;
    /**
     * The query_constraints property
     */
    private QueryConstraintsSC queryConstraints;
    /**
     * Instantiates a new {@link QueryConstraintsResponseSCCount} and sets the default values.
     */
    public QueryConstraintsResponseSCCount() {
    ...
    public static QueryConstraintsResponseSCCount createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new QueryConstraintsResponseSCCount();
    }
    /**
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("content", (n) -> { this.setContent(n.getObjectValue(Count::createFromDiscriminatorValue)); });
     ...
     */
    public void setContent(@jakarta.annotation.Nullable final Count value) {
        this.content = value;
    }
    /**
