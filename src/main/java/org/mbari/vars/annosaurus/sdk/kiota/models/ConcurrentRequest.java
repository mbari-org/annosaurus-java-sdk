...
public class ConcurrentRequest implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link ConcurrentRequest} and sets the default values.
     */
     ...
     * @return a {@link ConcurrentRequest}
     */
    @jakarta.annotation.Nonnull
    public static ConcurrentRequest createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
    ...
    /**
     * Gets the endTimestamp property value. The endTimestamp property
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("endTimestamp", (n) -> { this.setEndTimestamp(n.getStringValue()); });
        deserializerMap.put("startTimestamp", (n) -> { this.setStartTimestamp(n.getStringValue()); });
        deserializerMap.put("videoReferenceUuids", (n) -> { this.setVideoReferenceUuids(n.getCollectionOfPrimitiveValues(UUID.class)); });
        return deserializerMap;
    }
    /**
     * Gets the startTimestamp property value. The startTimestamp property
     * @return a {@link String}
     */
    @jakarta.annotation.Nullable
    ...
    public void serialize(@jakarta.annotation.Nonnull final SerializationWriter writer) {
        ...
        writer.writeStringValue("endTimestamp", this.getEndTimestamp());
        writer.writeStringValue("startTimestamp", this.getStartTimestamp());
    ...
    /**
     * Sets the endTimestamp property value. The endTimestamp property
     * @param value Value to set for the endTimestamp property.
     */
    public void setEndTimestamp(@jakarta.annotation.Nullable final String value) {
        this.endTimestamp = value;
    }
    /**
     * Sets the startTimestamp property value. The startTimestamp property
     * @param value Value to set for the startTimestamp property.
     */
